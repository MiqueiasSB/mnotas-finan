...
class GVendasPorPeriodo extends Component {
    ...
    //Escuta chamada da função pelo pai(painel)
    //protected $listeners = ['atualizarGraficos' => 'atualizarGrafico'];
    ...
    public function render() {
        ...
        return view('livewire.graficos.gVendasPorPeriodo');
    }
    public function atualizarGrafico() {
        ...
        $this->dispatch('atualizaGrafico', [
            ...
            'dadosReceita' =>  json_encode($this->dadosReceita),
            'dadosDespesa' => json_encode($this->dadosDespesa)
        ]);
    }
