...
return [
    ...
    */
    ...
    'password' => [
        'letters' => 'O campo senha deve conter pelo menos uma letra.',
        'mixed' => 'O campo senha deve conter pelo menos uma letra maiúscula e uma letra minúscula.',
        'numbers' => 'O campo senha deve conter pelo menos um número.',
        'symbols' => 'O campo senha deve conter pelo menos um símbolo.',
        'uncompromised' => 'O campo senha fornecido apareceu em um vazamento de dados. Por favor, escolha um senha diferente.',
    ],
